  ...
  return (
    <div>
      <div className="flex space-between w-full">
        ...
        <Button className='mr-2 ml-auto bg-[green]' onClick={openModal} >
          New Goal
        </Button>
      </div>
      <div className='px-5'>
      ...
      <div className={goalStyles.btnContainer}>
        <button className={goalStyles.greenBtn} onClick={openModal} type='button'>All Goals <ChevronDown className={goalStyles.btnIcons} /></button>
